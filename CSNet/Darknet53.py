...
class Darknet53(nn.Module):
    ...
    def forward(self, entry):
        ...
        print(conv28_43.shape, conv44.shape, conv45_52.shape)
        return  conv28_43 # YOLOv3用，所以输出了3次特征

if __name__ == '__main__':
    net = Darknet53()
    net.to(device='cpu')
    # net.load_state_dict(torch.load("yolov3_weights.pth",map_location='cpu'),strict=False)
